...
1. Tu e il proprietario firmate l'accordo di diritto di superficie
2. La società di noleggio acquista l'impianto dall'installatore
3. L'installatore monta i pannelli sul tetto
4. Tu paghi il canone mensile e usi l'energia prodotta
5. A fine contratto: riscatti l'impianto, rinnovi o restituisci (in questo caso, la società di noleggio gestisce la rimozione)
...
**Il proprietario del capannone ha diritti sull'energia prodotta?**
No. L'energia prodotta dall'impianto è per l'utilizzatore (l'affittuario). Il proprietario non ha diritti né obblighi sull'energia.

**Serve un notaio per il diritto di superficie?**
Per il noleggio operativo, di solito basta una scrittura privata. Per il leasing con iscrizione catastale, potrebbe servire un atto notarile. Dipende dalla società e dall'importo.

**Cosa succede all'impianto se il contratto di affitto scade prima del noleggio?**
Il contratto di diritto di superficie è indipendente dal contratto di affitto. Se il contratto di affitto scade, il diritto di superficie resta valido fino alla scadenza del noleggio. È una tutela per l'azienda e la società di noleggio.

[Verifica la fattibilità per il tuo capannone](/contatti). Ti aiutiamo con tutta la documentazione.
